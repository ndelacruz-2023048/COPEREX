...
import { generateExcel, getCompanies, getCompaniesByCategory, getCompaniesFilterAlphabetic, getCompaniesYearsTrajectory, newCompany, updateCompany } from "./company.controller.js";
...
apiCompany.get('/generate_excel',validateJwt,generateExcel)
